...
class PatchAnalysisTest(unittest.TestCase):
    ...
    def test_bug_analysis(self):
        ...
        self.assertEqual(info['code_churn_overall'], 212)
        self.assertEqual(info['code_churn_last_3_releases'], 37)
        self.assertEqual(info['developer_familiarity_overall'], 15)
        self.assertGreaterEqual(info['developer_familiarity_last_3_releases'], 3)
        ...
        self.assertEqual(info['code_churn_overall'], 182)
        self.assertEqual(info['code_churn_last_3_releases'], 29)
        ...
        self.assertEqual(info['modules_num'], 3)
        self.assertEqual(info['r-ed_patches'], 0)
        self.assertEqual(info['code_churn_overall'], 255)
        self.assertEqual(info['code_churn_last_3_releases'], 252)
